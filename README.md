...
Below this I have an image included of the band playing at a event. I thought this was fitted to the page after the welcome message section.
I have a section below the image message to state to users where the band have events.
Also there is a little greeting message follwed by a button to listen to music which brings you to the music page. 
Then I have included is a footer with social media icons, I have included in all four pages which is white font and red background.

### Music page  ###

The navbar is included in this page so the user can access other pages while on this page.
There is the name of the four songs featured at the top of the page befor the youtube clips.
...
This page was created so that users could view the events.
...
with a message to the fans and an button leading to the music page as an option. My footer is a red colour with copy right details at the bottom of my pages and social media links.
...
top four selling hits that the band ahs released for the fans to see and then I added four youtube clips to the page that can be played. This page was finshed with my footer included is social media links.
...
as a black font. I also included a button that links too the contact page also. Below this Included photos of the band and members for users to see.
